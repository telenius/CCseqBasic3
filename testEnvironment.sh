...
echo
ls ${mainScriptFolder}/dpnIIcutGenome3.pl
scriptFilesMissing=$(( ${scriptFilesMissing} + $? ))
...
# scriptFilesMissing=$(( ${scriptFilesMissing} + $? ))
# ls ${mainScriptFolder}/hindIIIcutReads3.pl
# scriptFilesMissing=$(( ${scriptFilesMissing} + $? ))
...
echo '     |   |-- dpnIIcutGenome3.pl dpnIIcutReads3.pl nlaIIIcutGenome3.pl nlaIIIcutReads3.pl'
