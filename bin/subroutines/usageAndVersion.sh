...
echo "Where run.sh is oneliner like : '${PipePath}/${nameOfScript} RunOptions' "
...
echo "${CapturePipePath}/${nameOfScript} -o /path/to/oligo/file.txt --R1 /path/to/read1.fastq --R2 /path/to/read2.fastq --genome mm9 --pf /public/username/location/for/UCSC/visualisation/files"
...
echo "--globin : combine captures from alpha globin capture sites (HbA1 and HbA2)"
echo
...
echo
echo "CAPTURE-C FILTERING OPTIONS"
